...
export default function GiftPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
              ...
              <AnimatePresence>
                {showSurprise && (
                  ...
                  >
                    ...
                    >
                      This friendship is something I’ll never let fade…🌹
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      Just like the bond we share. I promise to always value it and never take never take it for granted.💖
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      You’ll always be an important person in my life.💕✨
                    </motion.p>
                  </motion.div>
                )}
              </AnimatePresence>
      ...
      {/* Added text at the bottom-right corner */}
